...
//                LogUtil.d("extendedBluetoothDevice:" + extendedBluetoothDevice);
    ...
    @ReactMethod
    public void getAllValidFingerprintsWithLockData(String lockData, String macDev, Callback successCallback, Callback fail) {
        PermissionUtils.doWithConnectPermission(getCurrentActivity(), success -> {
            if (success) {
                TTLockClient.getDefault().getAllValidFingerprints(lockData, macDev, new GetAllValidFingerprintCallback() {
                    @Override
                    public void onGetAllFingerprintsSuccess(String fingerprintStr) {
                        successCallback.invoke(String.valueOf(fingerprintStr));
                    }
                ...
                Log.d("DEBUG1231", "getAllValidFingerprintsWithLockData: " + mac);
