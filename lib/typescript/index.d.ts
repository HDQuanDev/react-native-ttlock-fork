...
declare class Ttlock {
    ...
    static getAllValidFingerprintsWithLockData(lockData: string, success: null | (() => void), fail: null | ((errorCode: number, description: string) => void)): void;
    /**
